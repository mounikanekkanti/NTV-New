...
export const Placeholder687 = ({ color = "#B42318", className }) => {
  return (
    <svg
      className={`placeholder-687 ${className}`}
      fill="none"
      height="20"
      viewBox="0 0 20 20"
      width="20"
    ...
    >
      <g className="g" clipPath="url(#clip0_117_20899)">
        <path
          className="path"
      ...
      <defs className="defs">
        <clipPath className="clip-path" id="clip0_117_20899">
